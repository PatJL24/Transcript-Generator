...
public class Transcript extends Student{
	 ...
	 * @param students - A Student Object containing information about a specific student.
	 * @param listOfGrades - A list of Lists containing all the grades of the student.
	 * @throws InvalidTotalException - Throws an Exception if the total weight within a Course Object is above or below 100.
	 */
...
class Student{
	...
	public Student(String studentID, String name, ArrayList<Course> courses) {
		...
		for (int i = 0; i < courseTaken.size(); i++) 
			this.courseTaken.add(new Course(courses.get(i)));
	 ...
	 * @param grades - An ArrayList containing the grades of a course.
	 * @param weights - An ArrayList containing the weights of each assessments.
	 ...
	 * @param crs_actual - An ArrayList containing Course objects, or in other words containing courses.
	 */
